...
*&
*&---------------------------------------------------------------------*
REPORT ZEDR13_HW002 MESSAGE-ID ZMED13_100.
INCLUDE ZEDR13_HW002_TOP .
INCLUDE ZEDR13_HW002_SCR .
INCLUDE ZEDR13_HW002_F01 .
INCLUDE ZEDR13_HW002_PBO .
INCLUDE ZEDR13_HW002_PAI .
...
START-OF-SELECTION .
  ...
  IF P_RORD = C_X .
    ...
    PERFORM GET_DATA_STUDENT_ORDER .
    PERFORM GET_DATA_MATR_ORDER .
    PERFORM MODIFY_DATA .
    CALL SCREEN 100 .
  ENDIF.
  IF P_RDELV = C_X .
    PERFORM GET_DATA_DELIVERY .
    PERFORM GET_DATA_STUDENT_DELIVERY .
    PERFORM GET_DATA_MATR_DELIVERY .
    PERFORM MODIFY_DATA .
    CALL SCREEN 200 .
  ENDIF.